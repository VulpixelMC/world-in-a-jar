...
public final class Assertions {
	...
	public static void checkSide(Side side) {
		if (!side.equals(WorldInAJar.getHelper().getSide())) {
			throw new AssertionError("Incorrect Side `" + WorldInAJar.getHelper().getSide() + "`; expected `" + side + "`");
		}
	}
